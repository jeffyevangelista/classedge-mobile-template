...
// // Connector.ts (Updated)
// import { POWERSYNC_TOKEN } from "@/env";
// import {
//   PowerSyncBackendConnector,
//   AbstractPowerSyncDatabase,
//   UpdateType,
...
//   async fetchCredentials() {
//     return {
//       endpoint: "https://694a2a7430605f245ffb9b8b.powersync.journeyapps.com",
...
//           case UpdateType.PUT:
//             // For 'PUT', typically use an UPSERT on your backend
//             await fetch(`https://your-api.com/reconcile/${op.table}`, {
//               method: 'POST',
//               body: JSON.stringify(record),
//             });
//             break;
//           case UpdateType.PATCH:
//             await fetch(`https://your-api.com/reconcile/${op.table}/${op.id}`, {
//               method: 'PATCH',
//               body: JSON.stringify(op.opData),
//             });
//             break;
